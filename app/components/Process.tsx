...
export default function Process() {
  return (
    <section className="relative w-full bg-surface/60 px-6 md:px-12 py-20 md:py-28">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-[28px] border border-border bg-surface/90 p-7 md:p-8"
            >
              ...
              <h3 className="mt-5 text-2xl font-serif text-foreground">{step.title}</h3>
              <p className="mt-3 text-sm md:text-base text-secondary leading-relaxed">{step.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
